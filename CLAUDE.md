...
- Test suite: pytest — **580 tests** (measured 2026-09-24 on #47; CI reports `580 passed`) — run with `pytest tests/ -q` before any commit
  - ⚠️ **Without a reachable redis you get "578 passed, 2 skipped", and the 2 skips are silent.**
